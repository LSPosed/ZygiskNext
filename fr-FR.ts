export default {
    ...
    dashboard: {
        ...
        kernelsu_denylist: 'La liste d\'exclusions de KernelSU fait référence dans le gestionnaire de root KernelSU aux applications dont l\'option \"Démontage des modules\" ou \"Unmount modules\" est activée dans leur profil.',
    ...
    settings: {
        ...
        nonroot_as_denylist: 'Traiter les applications non-root comme étant dans la liste d\'exclusions',
        ...
        zn_linker_desc: 'Utilise le linker interne plutôt que celui du système pour charger les modules, ce qui permet d\'améliorer la furtivité mais peut parfois provoquer des problèmes d\'incompatibilité.',
    },
    zygote_inject_state: {
        running: 'Actif',
